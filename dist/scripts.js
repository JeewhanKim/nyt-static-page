...
(function e(t, n, r) {
  function s(o, u) {
    ...
    /* NYRegion JSONP parser */
    document.addEventListener("DOMContentLoaded", require('./parser.js'));
  }, { "./lib/jquery-2.2.4.min.js": 2, "./parser.js": 3 }], 2: [function (require, module, exports) {
    ...
    NYTD.render_section_front = function (json) {
      ...
      var $main = $('#nyt-main');
      var $languageSelector = $('#languer-selector');
      /*
      ...
      */
      var getImageUrl = function getImageUrl(images) {
        var types = images[0].types.filter(function (t) {
          return t.type === "square320" || t.type === "wide";
        });
      ...
      */
      var contentParser = function contentParser(content, refinedContent) {
      ...
      */
      var viewController = function viewController(data) {
      ...
      */
      ...
      $languageSelector.find('li').click(function (e) {
